...
class SearchEngineNewsCrawler:
    ...
    def start_crawling(self):
        ...
        # naver url 생성
        url = self.makeUrl(search, page, page2)
        ...
        # 1차원 리스트로 만들기(내용 제외)
        self.makeList(news_url_1, self.news_url)
    ...
    def create_df(self, news_dates, news_titles, final_urls, news_contents):
        ###데이터 프레임으로 만들기###
        import pandas as pd
